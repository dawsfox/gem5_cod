...
#include "codelet/SCMUlate/include/common/system_config.hpp"
//#include "system_config.hpp"
#include <string>

//#include "codelet/su.hh"
//trying forward declaration instead
namespace gem5 {
  class SU;
}
...
namespace scm {
  ...
  class fetch_decode_module {
    ...
    public: 
      ...
      /** \brief logic to schedule an execute instruction (codelet) adapted for gem5_cod
       *
       *  We select a CU and we assign a new codelet to it. When it is done, we delete the codelet
       */
      ...
      /** Logic of tihs unit adapted for gem5 usage
       * 
       * Implements the behavior logic of a single tick of the fetch 
