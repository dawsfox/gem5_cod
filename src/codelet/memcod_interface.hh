#ifndef __CODELET_MEMCOD_INTERFACE_HH__
#define __CODELET_MEMCOD_INTERFACE_HH__

#include "base/statistics.hh"
#include "mem/port.hh"
#include "mem/qport.hh"
#include "params/MemcodInterface.hh"
...
class MemcodInterface : public ClockedObject
{
  private:
    ...
    class CIResponsePort : public QueuedResponsePort
    {
      ...
      protected:
        ...
        CIResponsePort(const std::string &_name, MemcodInterface *_ci,
    ...
    class CPUSidePort : public CIResponsePort
    {
      ...
      public:
        ...
        CPUSidePort(const std::string &_name, MemcodInterface *_ci,
                    const std::string &_label);
    ...
    class CIRequestPort : public QueuedRequestPort
    {
      ...
      protected:
        ...
        CIRequestPort(const std::string &_name, MemcodInterface *_ci,
    ...
    class CIReqPacketQueue : public ReqPacketQueue
    {
      ...
      public:
        ...
        CIReqPacketQueue(MemcodInterface &ci, RequestPort &port,
    ...
    class MemSidePort : public CIRequestPort
    {
      ...
      public:
        ...
        MemSidePort(const std::string &_name, MemcodInterface *_ci,
                    const std::string &_label);
    };
    ...
    {
      private:
        MemcodInterface *owner;
        PacketPtr blockedPacket;

      public:
        CodSideReqPort(const std::string& name, MemcodInterface *owner) :
    ...
    class CodSideRespPort : public ResponsePort
    {
      ...
      public:
        CodSideRespPort(const std::string& name, MemcodInterface *owner) :
    ...
    /// FIFO Codelet queue
    std::queue<runt_memcod_t> codQueue;
  ...
  protected:
    ...
    {
        MemcodInterfaceStats(statistics::Group *parent);
  ...
  public:
    ...
    /** constructor
     */
    MemcodInterface(const MemcodInterfaceParams &params);
...
#endif // __CODELET_MEMCOD_INTERFACE_HH__