...
loop:
  ...
  ADD R64B_4, R64B_4, 1;
  //  COD LoadSqTile_2048L R2048L_1, R64B_1, 320;  //  1280; //Load A
  //  COD LoadSqTile_2048L R2048L_2, R64B_2, 32;  //  128; //Load B
  COD LoadSqTile_2048L R2048L_1, R64B_1, 160;  //Load A
...
afterLoop:
//  COD StoreSqTile_2048L R2048L_3, R64B_3, 32;  //  128; //Load C
